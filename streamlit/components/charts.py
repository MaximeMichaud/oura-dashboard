...
# -- Line chart --
def line_chart(df, x, y_cols, colors=None, title="", y_label="",
               fill=False, smooth=True, dashed=None, height=None):
...
# -- Dual-axis chart --
def dual_axis_chart(df, x, left_cols, right_cols, title="",
                    left_label="", right_label="",
                    left_colors=None, right_colors=None,
                    bar_cols=None, height=None):
...
# -- Bar chart --
def bar_chart(df, x, y, color=None, title="", y_label="",
              thresholds=None, height=None):
...
def horizontal_bar(names, values, thresholds=None, max_val=100,
                   fixed_color=None, title="", height=None):
